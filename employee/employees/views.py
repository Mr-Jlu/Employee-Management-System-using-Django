...
class AddEmployeeContacts(CreateView):
    form_class = AddEmployeeContact
    template_name = 'employees/add_employee_contact.html'

    def get_context_data(self, **kwargs):
        context = super(AddEmployeeContacts, self).get_context_data(**kwargs)
